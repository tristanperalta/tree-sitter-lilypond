...
enum {
  ...
  aux_sym_block_repeat1 = 15,
  alias_sym_version_number = 16,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [23] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(14),
  ...
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 3),
